...
(function() {
  $(function() {
    ...
    Bookmarks = (function() {
      function Bookmarks() {
        var bookmark, bookmarks, parsed_bookmarks;
        this.bind_events();
        bookmarks = localStorage.getItem('bookmarks');
        parsed_bookmarks = JSON.parse(bookmarks);
        bookmark = this.find_bookmark(parsed_bookmarks);
        if (bookmark) {
      ...
      Bookmarks.prototype.bind_events = function() {
        $('#create_bookmark').click((function(_this) {
          return function(evt) {
        ...
        $('.clear_all_bookmarks').click((function(_this) {
          return function(evt) {
            _this.clear_all_bookmarks();
            return evt.preventDefault();
          };
        })(this));
        return $('.btc, .usd').click((function(_this) {
          return function(evt) {
            if ($(evt.currentTarget).hasClass('btc')) {
              $('.btc').addClass('hide');
              return $('.usd').removeClass('hide');
            } else if ($(evt.currentTarget).hasClass('usd')) {
              $('.usd').addClass('hide');
              return $('.btc').removeClass('hide');
            }
          };
        })(this));
      };
      ...
      Bookmarks.prototype.build_bookmarks_dom = function() {
        var bookmarks, parsed_bookmarks;
        bookmarks = localStorage.getItem('bookmarks');
        parsed_bookmarks = JSON.parse(bookmarks);
        return ['block', 'transaction', 'address'].forEach((function(_this) {
          return function(item, index) {
            var bkmrks;
            bkmrks = _.filter(parsed_bookmarks, function(bkmrk) {
              return bkmrk.bookmark_type === item;
            });
            if (!_.isEmpty(bkmrks)) {
              return _this.build_bookmarks(bkmrks);
            }
          };
        })(this));
      };
      ...
      Bookmarks.prototype.build_bookmarks = function(bookmarks) {
        ...
        _.each(bookmarks, (function(_this) {
          return function(bookmark, index) {
            var $bookmark_path_anchor, $bookmarks_ul, $delete_bookmark_anchor, $label_danger_span, $list_group_item_li, $sum_footer;
            $bookmarks_ul = $("#" + bookmark_type + "_bookmarks ul");
            $list_group_item_li = $('<li class="list-group-item"></li>');
            $bookmark_path_anchor = $("<a data-id='" + bookmark.id + "' class='bookmark_path address_balance' href='" + bookmark.path + "'>" + (_.truncate(bookmark.id, {
              length: 45
            })) + "</a>");
            ...
            if (bookmark_type === 'address') {
              ...
              return _this.fetch_address_balances(bookmark.id);
            }
          };
        })(this));
        return $('.delete_bookmark').click((function(_this) {
          return function(evt) {
            return _this.delete_bookmark(evt);
          };
        })(this));
      };

      Bookmarks.prototype.fetch_address_balances = function(address) {
        return $.getJSON("/addresses/" + address + ".json", (function(_this) {
          return function(data) {
            return _this.calculate_address_sum(data.data, 'add');
          };
        })(this));
      };

      Bookmarks.prototype.calculate_address_sum = function(address_data, operation_type) {
        var $sum, $sum_footer, $sum_li, $sum_usd, address_balance, existing_sum, formatted_btc, new_sum, new_usd, split_btc, sum_text, trimmed_sum_text, usd_exchange_rate, utility;
        $sum = $('#sum_btc');
        $sum_usd = $('#sum_usd');
      ...
      Bookmarks.prototype.create_bookmark = function(evt) {
        var bookmark, bookmark_options, bookmarks, marshalled_bookmarks;
        bookmarks = localStorage.getItem('bookmarks');
        if (bookmarks != null) {
        ...
        bookmark = this.find_bookmark(bookmarks);
        if (_.isUndefined(bookmark)) {
          ...
          return localStorage.setItem('bookmarks', marshalled_bookmarks);
        }
      };

      Bookmarks.prototype.set_bookmark_count_badge = function(bookmark_count) {
        if (bookmark_count > 0) {
          return $('#bookmark_count_badge').removeClass('hide').text(bookmark_count);
        } else {
          return $('#bookmark_count_badge').addClass('hide').text(0);
        }
      };

      Bookmarks.prototype.update_bookmark_btn = function() {
        $('#create_bookmark').attr('href', '/apps/bookmarks');
        return $('#create_bookmark_description').text('Bookmarked');
      };

      Bookmarks.prototype.delete_bookmark = function(evt) {
        var address, balance, marshalled_bookmarks, new_bkmks, parent_ul, parsed_bookmarks;
        ...
        new_bkmks = _.reject(parsed_bookmarks, function(bk) {
      ...
      Bookmarks.prototype.clear_all_bookmarks = function() {
        ...
        this.hide_sum();
        return this.set_bookmark_count_badge(0);
      };

      Bookmarks.prototype.hide_sum = function() {
        return $('#address_bookmarks .panel-footer').hide();
      };
  ...
  $(function() {
    ...
    Calculator = (function() {
      function Calculator(exchange_rate) {
        ...
        $('#btc_calculator_input, #usd_calculator_input').on('change keyup', (function(_this) {
          return function(evt) {
            var type;
            type = evt.currentTarget.id === 'btc_calculator_input' ? 'btc' : 'usd';
            return _this.calculate_exchange(evt.currentTarget.value, type);
          };
        })(this));
        $("input[name=bitcoin_calculator]:radio").change((function(_this) {
          return function(evt) {
            var type;
            ...
            if (type === 'btc') {
              ...
              if (!$('#btc_value').closest('div').hasClass('hide')) {
                return $('#btc_value').closest('div').addClass('hide');
              }
            } else if (type === 'usd') {
              if ($('#usd_calculator_input').closest('.form-group').hasClass('hide')) {
              ...
              if ($('#btc_value').closest('div').hasClass('hide')) {
                return $('#btc_value').closest('div').removeClass('hide');
              }
            }
          };
        })(this));
      ...
      Calculator.prototype.calculate_exchange = function(num, type) {
        var final_rate;
        final_rate = type === 'btc' ? this.exchange_rate * num : num / this.exchange_rate;
        if (type === 'btc') {
          $('#btc_value').text(num);
          $('#usd_value').text(final_rate.toFixed(2).toLocaleString());
          return $('#usd_calculator_input').val(final_rate.toFixed(2).toLocaleString());
        } else if (type === 'usd') {
          $('#usd_value').text(num);
          $('#btc_value').text(final_rate.toFixed(8));
          return $('#btc_calculator_input').val(final_rate.toFixed(8));
        }
      };
    ...
    return calculator = new Calculator($('body').data('exchange_rate'));
  });
...
(function() {
  $(function() {
    'use strict';
    var Blockchain, Panel, Poller, blockchain, panel, poller;
    Panel = (function() {
      function Panel() {
        this.panel_data = {
          start: {
          ...
          getbestblockhash: {
            details: 'Returns the hash of the best (tip) block in the longest block chain. Result `hex` (string) the block hash hex encoded',
            tier: 'free'
          },
          getblock: {
            details: 'If verbose is false, returns a string that is serialized, hex-encoded data for block `hash`. If verbose is true, returns an Object with information about block <hash>.',
            tier: 'free'
          },
          getblockchaininfo: {
          ...
          getblockheader: {
            details: 'If verbose is false, returns a string that is serialized, hex-encoded data for blockheader `hash`. If verbose is true, returns an Object with information about blockheader <hash>. Arguments: 1. `hash`          (string, required) The block hash 2. verbose           (boolean, optional, default=true) true for a json object, false for the hex encoded data',
            tier: 'free'
          },
          getchaintips: {
          ...
          gettxoutproof: {
            details: 'Returns a hex-encoded proof that `txid` was included in a block. NOTE: By default this function only works sometimes. This is when there is an unspent output in the utxo for this transaction. To make it always work, you need to maintain a transaction index, using the -txindex command line option or specify the block in which the transaction is included in manually (by blockhash). Return the raw transaction data.',
            tier: 'free'
          },
          gettxoutsetinfo: {
            details: 'Returns statistics about the unspent transaction output set. Note this call may take some time.',
            tier: 'free'
          },
          verifychain: {
          ...
          generate: {
            details: 'Mine blocks immediately (before the RPC call returns) Note: this function can only be used on the regtest network',
            tier: 'pro'
          },
          getgenerate: {
            details: 'Return if the server is set to generate coins or not. The default is false. It is set with the command line argument -gen (or bitcoin.conf setting gen) It can also be set with the setgenerate call.',
            tier: 'free'
          },
          setgenerate: {
            details: 'Set `generate` true or false to turn generation on or off. Generation is limited to `genproclimit` processors, -1 is unlimited. See the getgenerate call for the current setting.',
            tier: 'pro'
          },
          getblocktemplate: {
            details: 'If the request parameters include a `mode` key, that is used to explicitly select between the default `template` request or a `proposal`. It returns data needed to construct a block to work on. See https://en.bitcoin.it/wiki/BIP_0022 for full specification.',
            tier: 'pro'
          },
          getmininginfo: {
          ...
          getnetworkhashps: {
            details: 'Returns the estimated network hashes per second based on the last n blocks. Pass in [blocks] to override # of blocks, -1 specifies since last difficulty change. Pass in [height] to estimate the network speed at the time when a certain block was found.',
            tier: 'free'
          },
          ...
          submitblock: {
            details: 'Attempts to submit new block to network. The `jsonparametersobject` parameter is currently ignored. See https://en.bitcoin.it/wiki/BIP_0022 for full specification.',
            tier: 'pro'
          },
          addnode: {
            details: 'Attempts add or remove a node from the addnode list. Or try a connection to a node once.',
            tier: 'pro'
          },
          clearbanned: {
          ...
          getaddednodeinfo: {
            details: 'Returns information about the given added node, or all added nodes (note that onetry addnodes are not listed here) If dns is false, only a list of added nodes will be provided, otherwise connected information will also be available.',
            tier: 'free'
          },
          getconnectioncount: {
          ...
          ping: {
            details: 'Requests that a ping be sent to all other nodes, to measure ping time. Results provided in getpeerinfo, pingtime and pingwait fields are decimal seconds. Ping command is handled in queue with all other commands, so it measures processing backlog, not just network ping.',
            tier: 'free'
          },
          setban: {
          ...
          createrawtransaction: {
            details: 'Create a transaction spending the given inputs and creating new outputs. Outputs can be addresses or data. Returns hex-encoded raw transaction. Note that the transaction\'s inputs are not signed, and it is not stored in the wallet or transmitted to the network.',
            tier: 'pro'
          },
          ...
          getrawtransaction: {
            details: 'NOTE: By default this function only works sometimes. This is when the tx is in the mempool or there is an unspent output in the utxo for this transaction. To make it always work, you need to maintain a transaction index, using the -txindex command line option. Return the raw transaction data. If verbose=0, returns a string that is serialized, hex-encoded data for `txid`. If verbose is non-zero, returns an Object with information about `txid`.',
            tier: 'pro'
          },
          sendrawtransaction: {
            details: 'Submits raw transaction (serialized, hex-encoded) to local node and network. Also see createrawtransaction and signrawtransaction calls.',
            tier: 'pro'
          },
          signrawtransaction: {
            details: 'Sign inputs for raw transaction (serialized, hex-encoded). The second optional argument (may be null) is an array of previous transaction outputs that this transaction depends on but may not yet be in the block chain. The third optional argument (may be null) is an array of base58-encoded private keys that, if given, will be the only keys used to sign the transaction.',
            tier: 'pro'
          },
          createmultisig: {
            details: 'Creates a multi-signature address with n signature of m keys required. It returns a json object with the address and redeemScript.',
            tier: 'pro'
          },
          estimatefee: {
            details: 'Estimates the approximate fee per kilobyte needed for a transaction to begin confirmation within nblocks blocks.',
            tier: 'free'
          },
          estimatepriority: {
          ...
          estimatesmartfee: {
            details: 'WARNING: This interface is unstable and may disappear or change! Estimates the approximate fee per kilobyte needed for a transaction to begin confirmation within nblocks blocks if possible and return the number of blocks for which the estimate is valid.',
            tier: 'free'
          },
          estimatesmartpriority: {
            details: 'WARNING: This interface is unstable and may disappear or change! Estimates the approximate priority a zero-fee transaction needs to begin confirmation within nblocks blocks if possible and return the number of blocks for which the estimate is valid.',
            tier: 'free'
          },
          validateaddress: {
      ...
      Panel.prototype.update = function(action_type, http_verb) {
        if (this.panel_data[action_type].tier === 'free') {
          $('.alert').addClass('hide');
    ...
    Blockchain = (function() {
      function Blockchain(panel1) {
        this.panel = panel1;
        this.bind_events();
      }

      Blockchain.prototype.bind_events = function() {
        $('#flavors a').click((function(_this) {
          return function(evt) {
        ...
        $('.parent_folder').click((function(_this) {
          return function(evt) {
            var $current_target, $requests;
            ...
            if ($requests.hasClass('hide')) {
              return $requests.removeClass('hide').addClass('active');
            } else {
              return $requests.addClass('hide').removeClass('active');
            }
          };
        })(this));
        $('.requests li').click((function(_this) {
          return function(evt) {
            var $current_target;
            $('.requests li.active').removeClass('active');
            $current_target = $(evt.currentTarget);
            if ($current_target.hasClass('active')) {
              return $current_target.removeClass('active');
            } else {
              return $current_target.addClass('active');
            }
          };
        })(this));
        $('#title').click((function(_this) {
          return function(evt) {
            var $details;
            $details = $('#details');
        ...
        $('#controls ul a:not(#destroy_chain)').click((function(_this) {
          return function(evt) {
            var $action, $http_verb;
            $action = $(evt.currentTarget).find('code').text();
            $http_verb = $(evt.currentTarget).find('.http_verb').text().toLowerCase();
            _this.panel.update($action, $http_verb);
            return evt.preventDefault();
          };
        })(this));
        return $('#send').click((function(_this) {
          return function(evt) {
            var $action, blockchain_property, data, href;
            data = {};
            _.each($('.form.active input'), function(value, index) {
              var ref;
              if ($(value).attr('type') === 'checkbox') {
                return data[$(value).data('type')] = (ref = value.checked) != null ? ref : {
                  'true': 'false'
                };
              } else {
                return data[$(value).data('type')] = $(value).val();
              }
            });
            ...
            _this.clear_output('complete');
            _this.clear_output('in_progress');
            _this.update_output($("<li>Working....</li>"), 'in_progress');
            $.get(href, {
              ...
              _this.clear_output('complete');
              _this.clear_output('in_progress');
              return _.each(rsp, function(value, key) {
                return _this.update_output($("<li>" + key + ": " + value + "</li>"), 'complete');
              });
            });
            return evt.preventDefault();
          };
      ...
      Blockchain.prototype.update_output = function(output, output_type) {
        if (output_type == null) {
          output_type = 'in_progress';
        }
        if (output_type === 'in_progress') {
          return $('#output #in_progress').append(output);
        } else if (output_type === 'complete') {
          return $('#output #complete').append(output);
        }
      };

      Blockchain.prototype.clear_output = function(type) {
        return $("#output #" + type).html('');
      };

      Blockchain.prototype.update_button = function(output) {};

      Blockchain.prototype.reset_buttons = function() {
        return $('#new_blockchain, #delete_blockchain').removeClass('btn-danger btn-success').addClass('btn-primary');
      };
    ...
    Poller = (function() {
      function Poller(blockchain1) {
        this.blockchain = blockchain1;
      }

      Poller.prototype.confirm_node_created = function() {
        return $.get("confirm_node_created?title=" + ($('#blockchain_title').data('title')), (function(_this) {
          return function(rsp) {
            if (rsp.message === 'node created') {
              _this.blockchain.clear_output('in_progress');
              _this.blockchain.update_output($("<li>Node has been created.</li>"), 'complete');
              _this.blockchain.update_output($("<li>URL: " + ($('#controls').data('url')) + ".</li>"), 'complete');
              return _this.confirm_infrastructure_bootstrapped();
            } else {
              _this.blockchain.update_output($("<li>Working....</li>"), 'in_progress');
              return setTimeout(function() {
                return _this.confirm_node_created();
              }, 15000);
            }
          };
        })(this));
      ...
      Poller.prototype.confirm_infrastructure_bootstrapped = function() {
        return console.log('confirm_infrastructure_bootstrapped called');
      };
    ...
    if ($('#controls').data('chain_created') === true) {
      blockchain.update_output($("<li>Node has been created.</li>"), 'complete');
      return blockchain.update_output($("<li>URL: " + ($('#controls').data('url')) + ".</li>"), 'complete');
    } else {
      poller = new Poller(blockchain);
      if (!$('#controls').data('chain_created')) {
        return poller.confirm_node_created();
      }
    }
  });
